...
Academic co-authors + journal reviewers

**What data sources does it connect to?**
Demographic datasets downloaded from various sources.

**What are the main output artefacts?**
ggplot2 figures for publication, R code for sharing within the paper.

**Are there naming conventions or domain-specific abbreviations the assistant should know?**
HDF = Human Fertility Database; DHS = Demographic and Health Surveys; WIC = World Fertility Patterns; HDI = Human Development Index; ESS = European Social Survey.

**Any constraints or policies specific to this project?**
Ask before committing to a repo.

---

## Who are the developers

**Ryohei Mogi** — quantitative demographer, expert in fertility.
Personal site: <https://ryomogi.github.io/> · ORCID: 0000-0001-6654-2468

**Ewa Batyra** — quantitative demographer, expert in fertility.
Personal site: <https://ewabatyra.com/> · ORCID: 0000-0002-2967-1508
